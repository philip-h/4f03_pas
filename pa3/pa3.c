...
const char *error = "Useage: ./pa2.x i N L M c0 c1 c2\n"
               "Where\n"
...
int main(int argc, char* argv[]) {
    ...
    //Initialize the size of S to be l * m
    S = (char*)malloc(sizeof(char)*l*m);
    S[0] = '\0';
